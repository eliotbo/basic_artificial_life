...
fn Simulation(
	...
	for (var j: i32 = -I; j <= I; j = j + 1) {
        ...
        var data: GridSlotEncoded = buffer_b.pixels[get_index(vec2<i32>(tpos))];
...
fn update(@builtin(global_invocation_id) invocation_id: vec3<u32>) {
    ...
    var data: GridSlotEncoded = buffer_b.pixels[get_index(location)];
    ...
    buffer_c.pixels[get_index(location)] = U;
